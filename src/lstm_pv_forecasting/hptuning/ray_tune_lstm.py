...
def get_search_space(params: dict, same_units: bool) -> dict:
    ...
    search_space = {
        ...
        "model_params": {
            ...
            "dropout": tune.loguniform(1e-7, 0.5),
...
def tune_hyper_params(params: dict, same_units: bool, num_samples: int):
    ...
    df_results.rename(columns={"config/model_params/lstm_units": "lstm_units",
                               ...
                               "config/model_params/dense_kernel_regularizer/config/l1": "kernel_regularizer_l1",
                               "config/model_params/dense_kernel_regularizer/config/l2": "kernel_regularizer_l2",
                               "config/model_params/dense_bias_regularizer/config/l1": "bias_regularizer_l1",
                               "config/model_params/dense_bias_regularizer/config/l2": "bias_regularizer_l2",
                               }, inplace=True)
    logger.info(f"Results: {df_results.loc[:, ["nrmse", "lstm_units", "dense_units", "dropout",
...
if __name__ == "__main__":
    util_logging.setup_logging(logfilename_prefix="ray_tune_lstm")
